    ...
    <section class="slider_section mb-30">
      <div class="slider_area owl-carousel">
        <div
          ...
          data-bgimg="user/assets/img/slider/slider3.jpg"
        >
          <div class="container">
            <div class="row">
              <div class="col-12">
        ...
        <div
          class="single_slider d-flex align-items-center"
          data-bgimg="user/assets/img/slider/slider1.jpg"
        >
          <div class="container">
            <div class="row">
              <div class="col-12">
        ...
        <div
          class="single_slider d-flex align-items-center"
          data-bgimg="user/assets/img/slider/slider2.jpg"
        >
          <div class="container">
            <div class="row">
              <div class="col-12">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <figure class="single_banner">
              <div class="banner_thumb">
                <a href="shop.html"
                  ><img src="user/assets/img/bg/banner1.jpg" alt=""
                /></a>
          ...
          <div class="col-lg-6 col-md-6">
            <figure class="single_banner">
              <div class="banner_thumb">
                <a href="shop.html"
                  ><img src="user/assets/img/bg/banner2.jpg" alt=""
                /></a>
                <div class="banner_content">
                  <h3>Top Products</h3>
                  <h2>
                  ...
                  <figure>
                    <div class="product_thumb">
                      ...
                      <div class="label_product">
                        <span class="label_sale">{{$item->badge}}</span>
                      </div>
                      <div class="action_links">
                        <ul>
                          ...
                          <form action="{{route('addwishlist',$item->id)}}" method='post'>
                          @csrf
                          <input type="number" value="1" min="1" name="quantity" hidden>
                          <li class="add_to_cart">
                            <button><i class="icon-shopping-bag"></i></button>
                    ...
                    <article class="single_product">
                      <figure>
                        ...
                        <figcaption class="product_content">
                          ...
                          <h4 class="product_name">
                            <a href="product-details.html">sapien libero</a>
                          </h4>
                          <div class="price_box">
                    ...
                    <article class="single_product">
                      <figure>
                        ...
                        <figcaption class="product_content">
                          ...
                          <h4 class="product_name">
                            <a href="product-details.html">vulputate rutrum</a>
                          </h4>
                          <div class="price_box">
                    ...
                    <article class="single_product">
                      <figure>
                        <div class="product_thumb">
                          <a class="primary_img" href="product-details.html"
                            ><img
                              src="user/assets/img/product/product10.jpg"
                              alt=""
                          /></a>
                          <div class="label_product">
        ...
        <div class="row">
          <div class="col-12">
            <div class="banner_fullwidth_content">
              ...
              <p>Discount 20% Off For Plant Palace Members</p>
              ...
              <div class="col-12">
                <div class="single-testimonial">
                  <div class="testimonial-icon-img">
                    <img
                      src="user/assets/img/about/testimonials-icon.png"
                      alt=""
                    />
                  </div>
                  <div class="testimonial_content">
                    ...
                    <div class="testimonial_text_img">
                      <a href="#"
                        ><img
                          src="user/assets/img/about/testimonial1.png"
                          alt=""
                      /></a>
                    </div>
                ...
                <div class="single-testimonial">
                  ...
                  <div class="testimonial_content">
                    ...
                    <div class="testimonial_text_img">
                      <a href="#"
                        ><img
                          src="user/assets/img/about/testimonial2.png"
                          alt=""
                      /></a>
                    </div>
                    <div class="testimonial_author">
                ...
                <div class="single-testimonial">
                  ...
                  <div class="testimonial_content">
                    ...
                    <div class="testimonial_text_img">
                      <a href="#"
                        ><img
                          src="user/assets/img/about/testimonial3.png"
                          alt=""
                      /></a>
                    </div>
                    <div class="testimonial_author">
                ...
                <figure>
                  <div class="blog_thumb">
                    <a href="blog-details.html"
                      ><img src="user/assets/img/blog/blog1.jpg" alt=""
                    /></a>
                  </div>
            ...
            <div class="col-lg-3">
              <article class="single_blog">
                <figure>
                  <div class="blog_thumb">
                    <a href="blog-details.html"
                      ><img src="user/assets/img/blog/blog2.jpg" alt=""
                    /></a>
                  </div>
                  <figcaption class="blog_content">
                    <h4 class="post_title">
            ...
            <div class="col-lg-3">
              <article class="single_blog">
                <figure>
                  <div class="blog_thumb">
                    <a href="blog-details.html"
                      ><img src="user/assets/img/blog/blog3.jpg" alt=""
                    /></a>
                  </div>
                  <figcaption class="blog_content">
                    <h4 class="post_title">
